...
class SkalePage extends StatelessWidget {
  const SkalePage({super.key, required this.controller});
            ...
            children: [
              Container(
                ...
                child: DropdownButton<String>(
                  ...
                  onChanged: controller.allButton
                      ? (String? valor) {
                          if (!controller.dropDownButton(valor!) &&
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              snackMessage(controller.mensagemSnackBar ??
                                  "Error not found"),
                            );
                          }
                        }
              ...
              Container(
                ...
                alignment: Alignment.center,
                child: Text(
                  "Tabela de chegada (X) < ${controller.x.toStringAsFixed(2)}",
                  style: primaryStyle(size: 20, color: Colors.white),
                ),
              ),
              Container(
              ...
              Container(
                width: size.width,
                height: 55 + controller.fixHeightFila(),
                margin: const EdgeInsets.only(bottom: 8),
                decoration: boxDecorationTopRightLeft(
                  radius: 16,
                  color: Colors.grey,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      height: 60 + controller.fixHeightFila(),
